    ...
    render() {
        return (
            <div>
                    ...
                    <img src="https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/newspaper-rec300c.jpg"
                         />
                    ...
                    <div class="row">
                        <div class="col-4">
                            <img src="https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/69-696x464.jpg" alt="..." style={{ width: '100%' }} />
                        </div>
                        <div class="col-8">
                    ...
                    <div class="row py-4">
                        <div class="col-4">
                            <img src="https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/68-696x464.jpg" alt="..." style={{ width: '100%' }} />
                        </div>
                        <div class="col-8">
                            Modern Monochrome Home with Calm and Cosy Terrace and Steps
                            August 7, 2019
                    ...
                    <div class="row">
                        <div class="col-4">
                            <img src="https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/67-696x464.jpg" alt="..." style={{ width: '100%' }} />
                        </div>
                        <div class="col-8">
                            Modern Monochrome Home with Calm and Cosy Terrace and Steps
                            August 7, 2019
                    ...
                    <div class="row py-4">
                        <div class="col-4">
                            <img src="https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/66-696x465.jpg" alt="..." style={{ width: '100%' }} />
                        </div>
                        <div class="col-8">
                            Modern Monochrome Home with Calm and Cosy Terrace and Steps
                            August 7, 2019
